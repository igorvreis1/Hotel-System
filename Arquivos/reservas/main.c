...
int verData(tipoData data, tipoHora hora, tipoDataOut dataOut, int diaAtual,int mesAtual ,int anoAtual){
    ...
    if(data.mes==2 && data.dia<1 &&                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               data.dia>28){
        ...
        printf("Data Ivalida, realize o chec-in novamente");
        return 1;
    }else if(data.ano< anoAtual || data.mes< mesAtual || data.dia){
        printf("Data Ivalida, realize o chec-in novamente");
        return 1;
    }
